		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Physical inventory count POC",
									"targetURL": "#PhysicalinventorycountPOC-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PhysicalinventorycountPOC-display": {
								"semanticObject": "PhysicalinventorycountPOC",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gsk.zphysicalinventory",
									"url": sap.ui.require.toUrl("com/gsk/zphysicalinventory")
								}
							}
						}
					}
